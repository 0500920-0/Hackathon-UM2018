<!DOCTYPE html>
  ...
  <nav style="background-color: #1ABC9C">
   ...
   <a class='dropdown-trigger btn-floating btn-large halfway-fab waves-effect waves-light teal' href='#' data-target='dropdown1' style="float: right;"><i class="material-icons">more_vert</i></a>
    ...
    <li><div class="user-view">
      ...
      <a href="#name"><p class="white-text name"><font size="2">澳大用戶電子賬單</font></p><p class="white-text name"><font size="2">eBill</font></p></a>
      <a href="#email" id="email"><span class="white-text email"></span></a>
    </div></li>
    <li><a href="account.php" class="waves-effect"><i class="material-icons">home</i>總覽 :: OVERVIEW</a></li>
    
    <li><div class="divider"></div></li>
    <li><a class="subheader">帳號</a></li>
    <li><a class="waves-effect" href="s_changePW.php"><i class="material-icons">vpn_key</i>變更密碼 :: CHANGE PW</a></li>
 ...
 <script type="text/javascript">
  ...
  firebase.initializeApp(config);
     ...
     <script src="js/s_changePW.js"></script>
