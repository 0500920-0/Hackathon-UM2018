...
.wrapper{
	...
	<nav >
      ...
      <div class="nav-wrapper db">
		<div class="brand-logo center"><font size="4px">澳門大學電力管理系統管理員登入</font></div>
					...
					<div class="row margin">
        				...
        				<div class="row margin">
        					<div class="input-field col s12 center">
 							...
 							<center><a class="btn-floating btn-large waves-effect waves-light red" href="index.php" ><i class="material-icons">arrow_back</i></a><a class="btn-floating btn-large waves-effect waves-light yellow" href="s_login.php" ><i class="material-icons">swap_horiz</i></a>
 				<a class="btn-floating btn-large waves-effect waves-light green" onclick="login()" ><i class="material-icons">vpn_key</i></a></center>

 				
             <p class="margin center-align medium-small"> <a class="waves-effect waves-light btn modal-trigger" href="#modal1">Forgot password ?</a></p>
         
 <div id="modal1" class="modal">
    <div class="modal-content">
      <h4>忘記密碼? :: FORGOT PASSWORD?</h4>
      <p>請與ICTO人員聯絡。</p>
      <p>Please contact ICTO staff.</p>
    </div>
      ...
      <a href="#!" class="modal-close waves-effect waves-green btn-flat">OK...</a>
			...
			<!-- <div id="modal1" class="modal">
    			<div class="modal-content">
      				...
      				<p>If you forget password, please ask for ICTO for help!</p>
    			</div>
    			<div class="modal-footer">
      			<a href="#!" class="modal-close waves-effect waves-green btn-flat">OK</a>
    			</div>
